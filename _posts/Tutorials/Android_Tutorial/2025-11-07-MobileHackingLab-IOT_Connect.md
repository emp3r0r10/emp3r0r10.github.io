...
To understand what a `Broadcast Receiver` is in more detail, you can explore it in the [Android Component](https://emp3r0r10.github.io/tutorials/Android_Application_Components/) tutorial.
